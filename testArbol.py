...
for personaje in super_heroes:
    if 'villano' in personaje:
        is_hero = False
        villanos.append(personaje["nombre"])
    else:
        is_hero = True
    personaje["is_hero"] = is_hero
    tree.insert_node(personaje["nombre"], personaje)

print("Los villano ordenados alfabeticamente ")
tree.inorden_villanos()

print("\nLos super heróes que cominezan con 'C' son ")
tree.inorden_superheros_start_with("C")

print(f"\nEn el arbol se encuentra {tree.contar_super_heroes()} super heróes")
...
value_to_delete = 'La Anforcha Humana'
...
print()
#f.listar los superhéroes ordenados de manera descendente;
print("lista de los superhéroes ordenados de manera descendente: ")
tree.postorden_superheros()


# creo un arbol nuevo y me fijo si es super heroe o villano 
print()
for villano in villanos:
    delete_value, extra_info = tree.delete_node(villano)
    treeVillanos.insert_node(delete_value, extra_info)
    
# determinar cuántos nodos tiene cada árbol;
print(f"El arbol de los villanos cuenta con ")
treeVillanos.cont_node()
print(f"El arbol de los super heroes cuenta con ")
tree.cont_node()

# . realizar un barrido ordenado alfabéticamente de cada árbol.
print("\nÁrbol de los villanos ordenado alfabeticamente: ")
treeVillanos.inorden()

print("\nÁrbol de los Super heroes ordenado alfabeticamente: ")
tree.inorden()
